...
plt.plot(data2['CryptoCurrency'], label = 'Closing Price (USD)', alpha =0.5,linewidth=1.5 )
plt.plot(data2['SMA30'], label = 'SMA30', alpha =0.5, linewidth=1.5)
plt.plot(data2['SMA100'], label = 'SMA100', alpha =0.5, linewidth=1.5)
...
plt.title("Closing Price (USD), Buy, and Sell Signals")
